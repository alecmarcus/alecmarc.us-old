<template>
  ...
  <nav id="primaryNav">
    <div class="conditional-wrapper">
      <transition
        :enter-class="
          this.$route.path === '/projects' ? 'push-up-enter' : 'push-down-enter'
        "
        :leave-to-class="
      ...
      >
        ...
        >
          ...
          <nuxt-link to="/projects" class="going-up">Index</nuxt-link>
        </div>
        <div v-else key="no-active-proj" class="content-wrapper">
          <h1 v-if="this.$route.path === '/'">
            <nuxt-link to="/projects" class="going-up"
              >Index of Projects</nuxt-link
            >
          </h1>
          <template v-else>
            <h1>Index of Projects</h1>
            <nuxt-link to="/" class="going-down">Home</nuxt-link>
          </template>
        </div>
      </transition>
    </div>
